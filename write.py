...
def write_learners():
    ...
    # Add learner Luis Vallejo
    learner_luis = Learner(
        first_name="Luis",
        last_name="Vallejo",
        dob=date(1984, 1, 2),
        occupation="data_scientist",
        social_link="https://www.linkedin.com/luis/",
    )
    learner_luis.save()
    # Add learner Juan Perez as a student
    learner_juan = Learner(
        first_name="Juan",
        last_name="Perez",
        dob=date(1999, 1, 2),
        occupation="student",
        social_link="https://www.linkedin.com/juan/",
    )
    learner_juan.save()
    # Add learner Maria Lopez as a data scientist
    learner_maria = Learner(
        first_name="Maria",
        last_name="Lopez",
        dob=date(1999, 1, 2),
        occupation="data_scientist",
        social_link="https://www.linkedin.com/maria/",
    )
    learner_maria.save()
    # Add learner Jane Doe as a developer
    learner_jane = Learner(
        first_name="Jane",
        last_name="Doe",
        dob=date(1999, 1, 2),
        occupation="developer",
