...
class User(models.Model):
    ...
    location = models.CharField(null=False, max_length=30, default="insert_location")
    email = models.EmailField(null=False, max_length=100, default="insert_email")
...
class Learner(User):
    ...
    ##Create a __str__ method returning a string representation
    def __str__(self):
        return (
            "First name: "
            + self.first_name
